  ...
  render() {
    return (
      ...
      <Header>
        ...
        <h1>Facultades</h1>
        <br />
          <Button color="success" onClick={()=>this.mostrarModalInsertar()}> + Agregar Facultad</Button>
          <br />
          <br />
          <div className="row mb-2">
            <div className="col-md-3">
                <input type="text" className="form-control" placeholder="Buscar Facultad" onChange={(e) => this.handleColumnSearch(e, facultad)}/>
            </div>
          </div>
          <Table>
            <thead>
        ...
        <Modal isOpen={this.state.modalInsertar}>
          <ModalHeader>
           <div><h3>Insertar Facultad</h3></div>
          </ModalHeader>
