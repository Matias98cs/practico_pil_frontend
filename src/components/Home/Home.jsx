          ...
          <Col md={4}>
            <Link to="/Personas">
              <Button variant="primary" className="boton-con-imagen">
                <div className="contenedor-texto">Personas</div>
              </Button>
            </Link>
          </Col>
          <Col md={4}>
            <Link to="/Carreras">
              <Button variant="secondary" className="boton-con-imagen2">
                <div className="contenedor-texto">Carreras</div>
              </Button>
            </Link>
          </Col>
          <Col md={4}>
            <Link to="/Universidades">
              <Button variant="success" className="boton-con-imagen3">
                <div className="contenedor-texto">Universidades</div>
              </Button>
            </Link>
          </Col>
        </Row>
          ...
          <Col md={4}>
            <Link to="/Facultades">
              <Button variant="danger" className="boton-con-imagen4">
                <div className="contenedor-texto">Facultades</div>
              </Button>
            </Link>
          </Col>
          <Col md={4}>
            <Link to="/Campus">
              <Button variant="warning" className="boton-con-imagen5">
                <div className="contenedor-texto">Campus</div>
              </Button>
            </Link>
          </Col>
          <Col md={4}>
            <Link to="/Programas">
              <Button variant="info" className="boton-con-imagen6">
                <div className="contenedor-texto">Programas</div>
              </Button>
            </Link>
          </Col>
        </Row>
